model Temperature_Connectors
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heatCapacitor(C = 500, T(fixed = true, start = 303.15)) annotation(
    Placement(visible = true, transformation(origin = {-70, 34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heatCapacitor1(C = 500, T(fixed = true, start = 283.15)) annotation(
