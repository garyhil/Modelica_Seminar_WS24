model Tanksystem_Connectors
  ...
  Modelica.Fluid.Vessels.OpenTank tank2(redeclare package Medium = Modelica.Media.Water.StandardWater, crossArea = (1^2)*0.25*Modelica.Constants.pi, height = 5, level(start = 4), level_start = 5, nPorts = 1, portsData = {Modelica.Fluid.Vessels.BaseClasses.VesselPortsData(diameter = 0.2, height = 0.0, zeta_in = 0.5, zeta_out = 0.5)}, use_Re = false, use_portsData = true) annotation(
    Placement(visible = true, transformation(origin = {-54, 90}, extent = {{0, -80}, {40, -40}}, rotation = 0)));
  Modelica.Fluid.Vessels.OpenTank tank1(redeclare package Medium = Modelica.Media.Water.ConstantPropertyLiquidWater, crossArea = 1^2*0.25*Modelica.Constants.pi, height = 5, level(start = 2), level_start = 2, nPorts = 1, portsData = {Modelica.Fluid.Vessels.BaseClasses.VesselPortsData(diameter = 0.2, height = 0.0, zeta_in = 0.5, zeta_out = 0.5)}, use_portsData = true) annotation(
